...
public class DataInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        createGroupIfAbsent("employees", "Employees");
        createGroupIfAbsent("managers", "Managers");
        createUserIfAbsent("alice", "Alice", "Employee", "alice@example.com");
        createUserIfAbsent("bob", "Bob", "Manager", "bob@example.com");
        addMemberIfAbsent("alice", "employees");
        addMemberIfAbsent("bob", "managers");
    }
