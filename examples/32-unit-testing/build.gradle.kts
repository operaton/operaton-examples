...
dependencies {
    ...
    // Unit test: in-memory engine without Spring or Docker
    testImplementation("org.operaton.bpm:operaton-engine:$operatonVersion:junit5")
    testImplementation("com.h2database:h2")

    // Integration test: Spring Boot + Testcontainers/PostgreSQL
